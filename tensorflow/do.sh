...
train_file="--train_files $file_dir/trainset/search.train2.json $file_dir/trainset/zhidao.train2.json"
dev_file="--dev_files $file_dir/devset/search.dev2.json"
...
param="--algo BIDAF --epochs 2 --batch_size 32 --embed_size 300 --gpu 0 --use_devset"
